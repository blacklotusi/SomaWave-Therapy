...
- (void)setup
{
	...
	self.toggleLayer = [[[[[self class] toggleLayerClass] alloc] initWithOnString:self.onText offString:self.offText onTintColor:[UIColor colorWithRed:(92.0/255.0) green:(85.0/255.0) blue:(79.0/255.0) alpha:1.0]] autorelease];
